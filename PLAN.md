...
## السيرفر (الإنتاج)
- **SSH:** `62.72.15.76:65002` — المستخدم `u546723891` — كلمة المرور في `scripts/server.env` (خارج git)
- **الدومين:** `eventssquare.sa`
- ⚠️ Cobra: بعد أول نشر — تحويل لمفاتيح SSH وتعطيل الدخول بكلمة المرور + تغييرها
